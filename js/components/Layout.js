...
import { auth } from '../core/firebase-config.js'; // Importamos auth directo

export const Layout = {
    render: (content, title = 'CRM') => {
        // 1. Intentamos obtener el usuario de Firebase directamente para evitar "Invitado"
        ...
        const role = 'Admin'; // Por ahora fijo
            ...
            btnLogout.addEventListener('click', async () => {
                if (confirm('¿Cerrar sesión?')) {
                    try {
                        ...
                        // Redirigir usando Hash para evitar 404
